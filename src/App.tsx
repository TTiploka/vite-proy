...
function App() {
  ...
  <div className='bg-stone-900 h-screen w-screen grid grid-cols-5 gap-2 p-20'> 
    ...
    <button className='bg-slate-600 rounded-md p-2 text-white ' ><div className="bg-slate-950 w-1/5 ml-1/2 border border-white rounded rounded-l-full ">X</div></button>
